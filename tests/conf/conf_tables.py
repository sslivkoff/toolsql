...
def get_simple_table():
    return {
        'schema': {
            'name': 'simple',
            'columns': {'id': {'type': int, 'primary': True}, 'name': str},
        },
        'rows': [
            (5, 'this'),
            (6, 'is'),
...
def get_pokemon_table():
    ...
    return {
        ...
        'rows': [
            # [1, 'Bulbasaur', 'GRASS', 318, 45, 49, 49, 65, 65, 45, 'hiss', 0.7, 15.2, 6.9, 14.1],
            # [2, 'Ivysaur', 'GRASS', 405, 60, 62, 63, 80, 80, 60, 'nice', 1.0, 28.7, 13.0, 13.0],

            [1, 'Bulbasaur', 'GRASS', 318, 45, 49, 49, 65, 65, 45, {'hi': ['GRASS', 'POISON']}, 0.7, 15.2, 6.9, 14.1],
            [2, 'Ivysaur', 'GRASS', 405, 60, 62, 63, 80, 80, 60, {'hi': ['GRASS', 'POISON']}, 1.0, 28.7, 13.0, 13.0],
